...
export const projects: Project[] = [
...

  {
    ...
    body: [
      ...
      'I worked alongside NB Studios, Silver, Pace, and Deluxe to streamline the final asset pipeline and the distribution rollout. The film opened nationwide on over 1,000 screens, made more than $1 million at the box office, and landed on the Los Angeles Times Top 10 list for the year.',
...

  {
    ...
    body: [
      'I produced this campaign film with Pepsi and Chicago designer Just Don through my production company XPOSURE. It marked the start of football season and the connection between sports and the city of Chicago.',
      'We shot it at the end of 2024 as a kickoff to the season. The goal was to put Pepsi and Just Don together on something that felt true to Chicago and its sports culture.',
...

  {
    ...
    body: [
      'In 2023 I produced the visual documentation of Chance the Rapper\'s Acid Rap 10 Year Anniversary Tour. Acid Rap came out in 2013 and became one of the defining mixtapes of the decade, and the tour brought it back ten years later.',
      'The anniversary run played sold-out arenas in Chicago, New York, and Los Angeles.',
      'I led production for the tour\'s visual coverage, put the creative team together, and oversaw how we documented the live shows.',
    ],
    vimeoId: '1171402172',
...

  {
    ...
    body: [
      'I directed and produced a three-part commercial campaign for designer Abel Paul George, made with Enigma Curation to introduce a limited hoodie release.',
      'We filmed at Serra Retreat, a Franciscan monastery in Malibu. The architecture and the quiet mountain setting shaped the tone of the films and gave the campaign a contemplative feel that matched the work.',
...

  {
    ...
    body: [
      'During New York Fashion Week in September 2024, I helped produce and document the first public activation for New Bible Belt. It was the group\'s debut event.',
      'We partnered with Realtree on a pop-up gathering built around community and creative exchange. It brought together artists and designers during one of the biggest weeks in fashion.',
      'We gave away more than 150 pounds of clothing for free to the people who came through, and the event drew over 300 attendees. It was New Bible Belt\'s first real presence at New York Fashion Week.',
    ],
    vimeoId: '1171405239',
...

  {
    ...
    body: [
      'I shot and edited Chance the Rapper\'s music video for "Stars Out," a 2024 single from his Star Line era. It\'s a confident, celebratory record, and the video plays to that.',
      'We filmed in Atlanta and Chicago. The idea was a cinematic portrait of Chance stepping back into the spotlight, with nightlife energy running underneath it.',
      'Between the camera work and the edit, I wanted something bold and immediate that matched the momentum around his return.',
    ],
...

  {
    ...
    subtitle: 'Chance the Rapper · Music Video',
    body: [
      'I produced and edited Chance the Rapper\'s music video for "Just a Drop," one of the key visuals from his album Star Line.',
      'We filmed at Vasquez Rocks outside Los Angeles and used the desert to build a futuristic, almost sci-fi world. That came out of something Chance and I talked about early on: building a larger visual universe for the Star Line era.',
      'I also found and secured the location, which ended up shaping a lot of the look. The terrain and the scale of the place carried the song\'s themes of reflection and resilience.',
    ],
...

  {
    ...
    subtitle: 'Chance the Rapper · Music Video',
    body: [
      'I edited and operated camera on Chance the Rapper\'s "YAH Know," an art project made with visual artist Mia Lee and featuring Ghanaian singer King Promise. It\'s part of his Star Line rollout, which pulls music, film, and art into one body of work.',
      'We filmed in Accra, Chicago, and Los Angeles, which speaks to the project\'s connection to the African diaspora. The piece sits somewhere between a music video and a gallery installation.',
...

  {
    ...
    subtitle: 'Chance the Rapper · Music Video',
    body: [
      'I edited and ran lead camera on Chance the Rapper\'s music video for "Together," a single produced by DJ Premier for the Star Line project.',
      'The video mixes performance with archival footage to get at what the song is about: family, the neighborhood, and holding onto community spaces. I wanted the edit to carry the emotional weight of the track and tie Chance\'s own story back to Chicago.',
    ],
...

  {
    ...
    body: [
      'Through my production company XPOSURE, I produced an album trailer for Chicago producer Bobby Beats. He\'s worked with a lot of artists and collectives around the city, including projects tied to Joey Purp and the Forever Band collective.',
      'We filmed in Lincoln Park, using the open space and the city around it to set the tone. The trailer works as a short cinematic intro to the album and to where his sound is headed.',
    ],
    vimeoId: '1171417204',
...

  {
    ...
    subtitle: 'Chance the Rapper · Music Video',
    body: [
      'I was the main camera operator and editor on Chance the Rapper\'s music video for "3333," filmed during his set at the Minnesota State Fair Grandstand. It captures a real moment between Chance and his fans that matches the gratitude in the song.',
      'We shot it while he was traveling the country hosting his "Writings on the Wall" listening experiences, an important stretch in the Star Line rollout.',
      'I kept the camera handheld and close to the performance so the crowd\'s energy carried the video. It documents a point where Chance reconnected with his fanbase.',
    ],
...

  {
    ...
    body: [
      'Through my production company XPOSURE, I produced the official album trailer for Vic Mensa\'s 2023 album Victor. It was the main visual for Roc Nation\'s rollout around the release.',
      'We filmed in New York City with Vic Mensa and actor Omari Hardwick. The trailer works as a cinematic intro to the album and sets up its emotional direction.',
...

  {
    ...
    body: [
      'I designed the official concert poster for Chance the Rapper\'s Coloring Book Ten Year Anniversary Tour, ten years after one of the most acclaimed projects in independent hip-hop.',
      'Coloring Book came out in 2016 and was the first streaming-only album to win a Grammy. For the poster I drew on the look of the original project and gave it a bold, typographic treatment that could hold up at arena scale.',
...

  {
    ...
    subtitle: 'Commercial Production',
    body: [
      'Through my production company XPOSURE, we produced a commercial campaign for the Chicago Bulls, Mitchell & Ness, and Just Don around the cultural legacy of basketball in Chicago. The film supported the brands\' Fall 2024 collection of hats and merch.',
      'We shot in Chicago and built the campaign around the childlike imagination that basketball brings out across the city, and the way the Bulls have shaped generations of fans here. The point was to show basketball as more than a sport in Chicago. It\'s part of the city\'s identity.',
...

  {
    ...
    body: [
      ...
      'I was the lead producer on the video and ran it from planning through final delivery.',
    ],
...

  {
    ...
    body: [
      ...
      'I was the lead producer on the video. I ran crew coordination and location scouting and edited the final cut.',
    ],
...

  {
    ...
    body: [
      ...
      'I edited the video and shaped the final cut and its rhythm.',
    ],
...

  {
    ...
    body: [
      ...
      'I was the lead producer on the performance video and oversaw the shoot through final delivery.',
    ],
...

  {
    ...
    body: [
      ...
      'I worked as a camera operator and editor, capturing the live set and assembling the final edit.',
    ],
...

  {
    ...
    body: [
      ...
      'I was the on-site producer in Accra and brought on a full crew of Ghanaian filmmakers to document it. We covered the whole week, including a conversation between Chance and Dave Chappelle at the University of Ghana.',
    ],
...

  {
    ...
    body: [
      ...
      'The documentary uses live concert footage that I directed and produced at Chance\'s earlier arena shows.',
    ],
...

  {
    ...
    body: [
      ...
      'I led the creative direction and art direction for the poster, building a bold typographic identity around the festival\'s Black Star symbolism and its mission of connecting the African diaspora.',
    ],
...

  {
    ...
    body: [
      'I was one of the lead developers on the design and concept work for the Yeezy Stem Player pop-up activations in 2022, the retail experiences built around Kanye West\'s Stem Player music device.',
      'My work covered the 3D product renders, the spatial concept, and the design of the activation environments. I took the Stem Player\'s circular, tactile form and turned it into a physical and visual language for the pop-up spaces.',
